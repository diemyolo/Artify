...
import com.example.artworksharingplatform.config.MomoConfig;
import com.example.artworksharingplatform.utils.MomoEncoder;

@RestController
@RequestMapping(value = "/api/auth/momo")
public class MomoPaymentController {
	...
	public Map<String, Object> createPayment( @RequestParam Long amount,
		...
		String hashData = MomoEncoder.signHmacSHA256(data, secretKey);
